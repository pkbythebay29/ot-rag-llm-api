...
batchers.register("generate", _forward_generate, max_batch=_cfg.batch.max_batch, max_latency_ms=_cfg.batch.max_latency_ms)
batchers.register("embed",     _forward_embed,     max_batch=_cfg.batch.max_batch, max_latency_ms=_cfg.batch.max_latency_ms)
batchers.register("rerank",    _forward_rerank,    max_batch=_cfg.batch.max_batch, max_latency_ms=_cfg.batch.max_latency_ms)
batchers.register("validate",  _forward_validate,  max_batch=_cfg.batch.max_batch, max_latency_ms=_cfg.batch.max_latency_ms)
...
async def ensure_started():
    ...
    if not _started:
        ...
        gate.set_policy("default", TenantPolicy(
